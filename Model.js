...
// The inverse of dateKey, for turning the selected day back into something
// Qt.formatDate can print. A malformed key falls back to the date given
// rather than to an Invalid Date that would render as empty text.
